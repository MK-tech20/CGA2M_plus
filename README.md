![](https://github.com/MK-tech20/CGA2M_plus/blob/main/images/cga2m_plus%2B.png) 
...
![](https://github.com/MK-tech20/CGA2M_plus/blob/main/images/constraint.png)   
...
# Algorithm  
![](https://github.com/MK-tech20/CGA2M_plus/blob/main/images/algorithm.png)
For more information, please read our paper. (coming soon!!) 
...
```
![](https://github.com/MK-tech20/CGA2M_plus/blob/main/images/plot_main.png) 

## Visualize (3d) the effect of pairs of features on the target variables
```python
plot_interaction(cga2m_no1,X_train,mode = "3d")
```
![](https://github.com/MK-tech20/CGA2M_plus/blob/main/images/plot_pairs.png) 
## Feature importance
```python
show_importance(cga2m_no1,after_prune=True,higher_mode=True)
```
![](https://github.com/MK-tech20/CGA2M_plus/blob/main/images/feature_importance.png) 
# License
MIT License
# Caution
